...
public class DefaultNIGUICursorAdd : NIGUICursor 
{
    ...
    public override bool HasClickedThisFrame()
    {
        if (m_active == false)
            return false;
        return m_input.GetAxis("NIGUI_CLICK_ADD")>=1.0f;
    }
    ...
    {
        m_input.RegisterCallbackForGesture(eventDelegate, "NIGUI_CLICK_ADD");
    }
    ...
    {
        m_input.UnRegisterCallbackForGesture(eventDelegate, "NIGUI_CLICK_ADD");
    }
    ...
    public override Vector2 PositionNormalized
    {
        get 
        {
            ...
            res.x = m_input.GetAxis("NIGUI_X_ADD")+0.5f; 
            res.y = m_input.GetAxis("NIGUI_Y_ADD")+0.5f; // the screen y axis is opposite to the camera's
            return res;
        }
    }
    ...
    public void OnDestroy()
    {
        ...
        {
            m_input.UnRegisterCallbackForGesture(GestureEventHandler, "NIGUI_CLICK_ADD");
    ...
    protected override void InternalOnGUI()
    {
        ...
        {
            m_input.RegisterCallbackForGesture(GestureEventHandler, "NIGUI_CLICK_ADD");
        ...
        float clickVal=m_input.GetAxis("NIGUI_CLICK_ADD");
        GUI.depth = 0;
        //GUI.Box(m_positionRect, "ADD");
        if (clickVal > 0)
        {
